...
export interface _SERVICE {
  'askQuestion' : ActorMethod<[string, string], string>,
  'clearHistory' : ActorMethod<[], undefined>,
  'getCategories' : ActorMethod<[], Array<string>>,
  'getChatHistory' : ActorMethod<[], Array<Message>>,
  'getMessagesByLanguage' : ActorMethod<[], Array<Message>>,
  'getSupportedLanguageCodes' : ActorMethod<[], Array<string>>,
  'getSupportedLanguages' : ActorMethod<[], Array<string>>,
