...
import type { Message as _Message, MessageRole as _MessageRole, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async askQuestion(arg0: string, arg1: string): Promise<string> {
    ...
    async getMessagesByLanguage(): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagesByLanguage();
                return from_candid_vec_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSupportedLanguageCodes(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSupportedLanguageCodes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
